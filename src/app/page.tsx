  ...
  return (
    <main className='w-full h-screen flex justify-center items-center'>
      <div className="bg-white rounded-lg shadow p-12 space-y-6 max-w-lg">
        <h1 className="text-2xl">Welcome to the Mona User Gater!</h1>
        <p>This service is a propotype for token gating content within Mona virtual spaces. Currently, we use your IP address to assign authorized avatars, but in the future would love to use your wallet address so we can validate ownership of specific NFTs in targeted collections.</p>
